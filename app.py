...
if st.button("Predict"):
    ...
    input_data_model['transmission']=input_data_model['transmission']=input_data_model['transmission'].replace(['Manual', 'Automatic'],[1,2], inplace=True)
    input_data_model['name']=input_data_model['name']=input_data_model['name'].replace(['Maruti', 'Skoda', 'Honda', 'Hyundai', 'Toyota', 'Ford', 'Renault',
